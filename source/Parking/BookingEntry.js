            ...
            <View
                ...
                <View
                    ...
                    <View
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginLeft: 30 }}>
                            <TouchableOpacity
                                ...
                                <Image source={{ uri: "https://raw.githubusercontent.com/Arabhya07092007/HolyAyodhya-assets/main/minus.png" }} style={{
                                    width: 27, height: 27,
                            ...
                            <TouchableOpacity
                                ...
                                <Image source={{ uri: "https://raw.githubusercontent.com/Arabhya07092007/HolyAyodhya-assets/main/plus.png" }} style={{
                                    width: 27, height: 27,
                    ...
                    <View style={{ marginTop: 10 }}>
                        ...
                        <Text
                            style={{
                                fontWeight: '400', color: 'black', color: 'black',
                                fontSize: 15,
                            }}>
                ...
                <View
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            if (name !== "" && phoneNo !== "" && vehicleNo !== "" && phoneNo.length === 10 && vehicleNo.length === 10) {
                                const paymentData = { name: name, phoneNo: phoneNo, vehicleNo: vehicleNo, amount: amount, duration: duration, address: data.address, parkingName: data.name, }
